...
static T_MyMfcOpr g_tMyMfcOPr;

SSBSIP_MFC_ERROR_CODE MyInitMfc(int w, int h, int qb){
...
static T_MyMfcOpr g_tMyMfcOPr = {
	.name		= "mfc",	
	.initMfc 	= MyInitMfc,
	.getHeader	= MyGetHeader,
	.getInputBuf= MyGetInputBuf,
	.encode		= MyEncode,
	.exitMfc	= MyExitMfc,	
};
