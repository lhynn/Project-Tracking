...
static void InitMenuSec(unsigned char*ptr){
	...
	osd_print_Chinese(262, 497,GREENPAN,ptr,MOSHI,2,4);
	...
	osd_print_Chinese(322, 497,GREENPAN,ptr,TUPIAN,2,4);
	...
	osd_print_Chinese(382, 497,GREENPAN,ptr,SHIPIN,2,4);
	...
	osd_print_Chinese(442, 497,GREENPAN,ptr,CAIDAN,2,4);
}
...
static void InitMenuFour_FD(unsigned char*ptr){
	...
	osd_print_string("1X",2,304,452,0xff,ptr,MYASCIIDOT);
	
	if(FANGDAFLAG == 1)
		osd_print_rect(360,450,GREENPAN,ptr);
	else
		osd_print_rect(360,450,0,ptr);
	osd_print_string("2X",2,384,452,0xff,ptr,MYASCIIDOT);
...
static void InitMenuFour_JX(unsigned char*ptr){
	...
	osd_print_Chinese(302, 452,GREENPAN,ptr,BAIRE,2,4);

	if(JIXINGFLAG)
		osd_print_rect(370,450,GREENPAN,ptr);
	else
		osd_print_rect(370,450,0xff,ptr);
	osd_print_Chinese(382, 452,GREENPAN,ptr,HEIRE,2,4);
}
...
static void InitMenuFour_FH(unsigned char*ptr){
	...
	if(FENHUAFLAG == 1)
		...
		osd_print_rect(290,450,0xff,ptr);
	osd_print_Chinese(302, 452,GREENPAN,ptr,GUANBI,2,4);

	if(FENHUAFLAG == 2)
		osd_print_rect(370,450,GREENPAN,ptr);
	else
		osd_print_rect(370,450,0xff,ptr);
	osd_print_Chinese(382, 452,GREENPAN,ptr,DAKAI,2,4);
}
