...
void ShowPicString(unsigned char *ptr,char *string){	
	...
	osd_print_24(string, 11,306,532,ptr);
...
void ShowVideoString(unsigned char *ptr,char *string){	
	...
	osd_print_Mypic(40,0,680,268,ptr,MYHEISEYUAN);
	osd_print_Mypic(24,0xff,688,276,ptr,CHONGBO_PIC);


	osd_print_Mypic(24,0,340,532,ptr,YUAN_24);
	osd_print_Mypic(16,0xff,344,536,ptr,BOFANG_PIC);
	if(ProState == DECODEPROSTOP){
		osd_print_Mypic(24,0,340,532,ptr,YUAN_24);
		osd_print_Mypic(16,0xff,344,536,ptr,ZANTING_PIC);
	}		

	osd_print_Mypic(24,0,284,532,ptr,YUAN_24);
	osd_print_Mypic(16,0xff,288,536,ptr,SHANGYIGE_PIC);

	osd_print_24(string,11,290,502,ptr);

	osd_print_Mypic(24,0,392,532,ptr,YUAN_24);
	osd_print_Mypic(16,0xff,396,536,ptr,XIAYIGE_PIC);
}
