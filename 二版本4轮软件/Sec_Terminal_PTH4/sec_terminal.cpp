...
/*****************************速度表盘****************************************/
    ...
    MBpView->setGeometry(1058,186,164,164);//1019

    SpeedDescription = new QLabel(this);
    SpeedDescription->resize(60,25);
    SpeedDescription->setFont(QFont("JPTZ",20,QFont::AnyStyle));
    SpeedDescription->setStyleSheet("QLabel{ color:white;};");
    SpeedDescription->move(1110,309);
    SpeedDescription->setText("3km/h");
/*****************************航向表盘****************************************/
    ...
    HXpView->setGeometry(1082,472,106,106);//1019
...
void  Sec_Terminal::PhyButtonDeal(int Num,int Type){
    ...
    case 8:MenuKeyEnter();
        break;
    case 9:MenuKeyReturn();
        break;
    case 10:
         GetPhotoOrVideo(Type);
        break;
    case 11:
        break;
    }
