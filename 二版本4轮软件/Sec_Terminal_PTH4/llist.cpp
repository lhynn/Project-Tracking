...
LLIST *llist_create(int size)
{
    ...
    iList = (LLIST *)malloc(sizeof(*iList));
    if(iList == NULL)
        return NULL;
    iList->size = size;
    iList->head.prev = iList->head.next = &iList->head;
    iList->insert    = llist_insert;
    iList->find      = llist_find;
    iList->idelete   = llist_delete;
    iList->fetch     = llist_fetch;
    iList->travel    = llist_travel;
    iList->getMemSum = getListMaxMember;
    return iList;
}
