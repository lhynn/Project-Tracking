...
**
** Created: Tue Jun 26 18:48:17 2018
...
static const char qt_meta_stringdata_Sec_Terminal[] = {
    "Sec_Terminal\0\0timerDone()\0Num,Type\0"
    "PhyButtonDeal(int,int)\0OsdUpdateFunc(int)\0"
};
...
int Sec_Terminal::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: OsdUpdateFunc((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
